...
const About: React.FC = () => {
    return (
        <section id="about" className="py-16 bg-gray-100 -mx-6 px-6">
            <div className="max-w-5xl mx-auto text-center">
                <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4">More Than an Organization. A Community.</h2>
                ...
                <div className="mb-8">
                    <img 
                        ...
                        className="w-full max-w-4xl mx-auto rounded-lg shadow-lg object-cover h-80 md:h-96 lg:h-[400px]"
                    />
                </div>
                ...
                <h3 className="font-serif text-2xl font-bold mb-8">Our Core Values Guide Everything We Do</h3>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 text-center mb-12">
                    {coreValues.map((value) => (
                        <div key={value.name} className="flex flex-col items-center">
                            <div className={`rounded-full p-4 mb-3 ${value.color === 'electric-mint' ? 'bg-electric-mint/20 text-electric-mint' : 'bg-amber/20 text-amber'}`}>
                                {value.icon}
                            </div>
                ...
                <div className="space-y-8 md:space-y-0 md:flex md:space-x-8 text-left bg-white p-8 rounded-lg shadow-md">
                    <div className="md:w-1/2">
                        <h3 className="font-serif text-2xl font-bold mb-3 text-electric-mint">Our Vision</h3>
                        <p className="text-gray-700">To light every campus with confident, well-rounded graduates ready to make their mark on the world.</p>
                    </div>
                    <div className="md:w-1/2 border-t-2 md:border-t-0 md:border-l-2 border-gray-200 pt-8 md:pt-0 md:pl-8">
                        <h3 className="font-serif text-2xl font-bold mb-3 text-amber">Our Mission</h3>
                        <p className="text-gray-700">To equip students with practical life skills, emotional resilience, and a supportive peer network through engaging programs and expert content.</p>
                    </div>
                </div>
            </div>
        </section>
